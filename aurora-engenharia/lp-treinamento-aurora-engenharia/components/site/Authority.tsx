    ...
    <Section id="autoridade" surface="paper">
      <div className="grid items-center gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:gap-16">
        ...
        <Reveal delay={0.1} className="flex flex-col gap-6">
          <span
            className="kicker inline-flex items-center text-[11px] font-medium"
            style={{ color: STEEL }}
          >
            {authority.eyebrow}
          </span>
            ...
            {authority.stats.map((s, i) => (
              ...
              >
                ...
                <span
                  className={
                    /[a-zA-Z]/.test(s.value)
                      ? "font-display text-lg font-extrabold leading-[1.1] md:text-xl"
                      : "font-display text-2xl font-extrabold tabular md:text-3xl"
                  }
                  style={{ color: INK }}
                >
